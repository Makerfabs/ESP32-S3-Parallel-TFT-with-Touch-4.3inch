...
static bsp_pcf85063a_handle_t _g_handle = NULL;
...
esp_err_t bsp_pcf85063a_init(bsp_pcf85063a_handle_t *handle, i2c_master_bus_handle_t bus_handle)
{
    esp_err_t ret = ESP_OK;
    ...
    bsp_pcf85063a_handle_t _handle = (bsp_pcf85063a_handle_t)malloc(sizeof(struct bsp_pcf85063a_t));
